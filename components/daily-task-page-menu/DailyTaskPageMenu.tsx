...
import { DailyTaskPageMenuContainer } from './styled';

interface DailyTaskPageMenuProps {
  // onTaskBaru?(): void
  onPilih?(): void
  onHapusSemua?(): void
  enableMenu?: boolean
...
export default function DailyTaskPageMenu(props: DailyTaskPageMenuProps) {
  return (
    <DailyTaskPageMenuContainer>
      {/* <TouchableOpacity onPress={props.onTaskBaru}>
